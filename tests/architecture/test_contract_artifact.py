...
def test_required_verdicts_present(artifact):
    ...
    required = {
        ...
        "signature_guessing_generation": "REPLACED -> #186 (explicit declared loop contract; no signature inspection)",
        "diffusion_gemma_class_swap": "REPLACED -> #186 (runtime __class__ swap removed; wrapper-first load owns the class)",
