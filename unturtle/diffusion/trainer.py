    ...
    sparse_lm_head: bool = field(
        ...
        metadata={
            "help": (
                ...
                "step time -61%% at 128K vocab / 15%% masking, -27%% at 50%%, "
                "-6.8%% at 75%%; and -26%% / -14%% / +1.6%% at 32K vocab.  Peak "
                "memory is the axis that turns: roughly neutral at the ~50%% "
                "ratio MDLM training averages (+0.2%% to +0.6%%) and worse above "
                "it (+30.7%% at 75%%).\n"
                "So the step-time win is real and large for big vocabularies, "
                "while memory is not automatically improved.  Defaults off; "
                "enable for large vocabularies at low mask ratios.  Note LoRA "
                "is worse above ~15%% masking (+36.8%% memory at 50%%) because "
                "the frozen backbone's activations already dominate.\n"
