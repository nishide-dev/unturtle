...
"""A2D (AutoRegressive→Diffusion) adapter for LLaMA models.
...
Usage::
    ...
    config = A2DLlamaConfig.from_pretrained("meta-llama/Meta-Llama-3-8B")
...
class A2DLlamaModel(transformers.LlamaModel):
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        # 1) No mask provided → all tokens are valid.
        ...
        # 2) Convert 1-D / 2-D padding mask to 4-D additive attention bias.
        if not (
